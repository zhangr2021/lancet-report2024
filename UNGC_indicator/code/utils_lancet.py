...
import nltk
import sys
sys.path.append("/content/drive/MyDrive/hertie/lancet/lancet_2024/result_2024/")
...
#with open("/content/drive/MyDrive/hertie/lancet/lancet_2024/stopwords.txt", "r") as fp:
...
def word_tokenize(text):
    sentences = sent_tokenize(text) #tokenizer.tokenize(text)
    return [
